...
public class ChangeSecurityQuestion extends javax.swing.JFrame {
    ...
    public ChangeSecurityQuestion(String email) {
        initComponents();
        userEmail = email;
        //txtOldSecurityQuestion.setEditable(true);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(148, 149, -1, -1));
        ...
        getContentPane().add(txtOldSecurityQuestion, new org.netbeans.lib.awtextra.AbsoluteConstraints(323, 102, 250, -1));
        ...
        getContentPane().add(txtNewSecurityQuestion, new org.netbeans.lib.awtextra.AbsoluteConstraints(324, 146, 249, -1));

        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Answer");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(148, 193, -1, -1));
        ...
        getContentPane().add(txtAnswer, new org.netbeans.lib.awtextra.AbsoluteConstraints(324, 190, 249, -1));

        jLabel5.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Password");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(148, 234, -1, -1));
        ...
        getContentPane().add(txtPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(324, 234, 249, -1));
        ...
        getContentPane().add(btnUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(324, 278, -1, -1));
        ...
        getContentPane().add(btnClear, new org.netbeans.lib.awtextra.AbsoluteConstraints(484, 278, -1, -1));
...
//User user = null;
//    try {
//        user = UserDao.getSecurityQuestion(userEmail);
//        if (user != null && user.getSecurityQuestion() != null) {
//            txtOldSecurityQuestion.setText(user.getSecurityQuestion());
//        } else {
//            txtOldSecurityQuestion.setText("User not found or security question not available.");
//        }
//
//        System.out.println("Retrieved Security Question: " + user.getSecurityQuestion());
//    } catch (SQLException ex) {
//        Logger.getLogger(ChangeSecurityQuestion.class.getName()).log(Level.SEVERE, null, ex);
//        txtOldSecurityQuestion.setText("Error retrieving security question. Please check logs.");
//    }
